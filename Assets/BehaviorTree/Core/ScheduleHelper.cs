...
namespace JFun.Gameplay.Utility
{
	...
	public class ScheduleHelper : MonoBehaviour
	{
		...
		public ITask NewScheuleRepeat(Action doSomething, float duration)
		{
			return new Tasks(StartCoroutine, StopCoroutine, doSomething, duration, int.MaxValue, null);
		}
